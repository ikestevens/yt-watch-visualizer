...
function updateFlags() {
  ...
  isLandscape = isMobile && windowWidth > windowHeight;
}
...
function drawLine() {
  let repetitions = isMobile ? (isLandscape ? 50 : 25) : 30;
  let spacing = isMobile ? (isLandscape ? 60 : 175) : 50;
  let waveSpeed = isMobile ? (isLandscape ? 0.002 : 0.0075) : 0.01;
  let waveAmplitude = isMobile ? (isLandscape ? 150 : 200) : 35;

  stroke(0);
  strokeWeight(isMobile ? (isLandscape ? 2 : 3) : 2);
  noFill();
